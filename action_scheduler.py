...
class ActionScheduler:
    ...
    def _execute_expression(self, action: Action):
        ...
        if "parameters" in action.data:
            self.vts.set_parameters(action.data["parameters"])
    
    def _execute_parameter(self, action: Action):
        """执行参数动作"""
        parameters = action.data.get("parameters", {})
        self.vts.set_parameters(parameters)
    ...
    def _interrupt_current_action(self, next_action: Action):
        """中断当前动作"""
        # 快速淡出
    ...
    def _apply_fade_out(self, action: Action, fast: bool = False):
        ...
        if action.action_type == ActionType.PARAMETER:
            ...
            self.vts.set_parameters(zero_params)
    ...
    def _create_emotion_action(self, emotion: str, intensity: float) -> Optional[Action]:
        ...
        EMOTION_CONFIG = {
            "开心": {
                ...
                "parameters": {"MouthOpen": 0.3 + 0.3 * intensity, "EyeOpenLeft": 0.7 + 0.3 * intensity, "EyeOpenRight": 0.7 + 0.3 * intensity},
                "duration": 2.0,
                "priority": ActionPriority.NORMAL
            },
            "生气": {
                "expression": "Angry.exp3.json",
                "parameters": {"MouthOpen": 0.2, "EyeOpenLeft": 0.4, "EyeOpenRight": 0.4, "FaceAngleY": -5 * intensity},
                "duration": 1.5,
                "priority": ActionPriority.NORMAL
            },
            "惊讶": {
                "expression": "Surprised.exp3.json",
                "parameters": {"MouthOpen": 0.7 + 0.3 * intensity, "EyeOpenLeft": 0.9, "EyeOpenRight": 0.9},
                "duration": 1.0,
                "priority": ActionPriority.HIGH
            },
            "难过": {
                "expression": "Sad.exp3.json",
                "parameters": {"MouthOpen": 0.1, "EyeOpenLeft": 0.3, "EyeOpenRight": 0.3, "FaceAngleX": -3 * intensity},
                "duration": 2.0,
                "priority": ActionPriority.NORMAL
            },
            "平静": {
                "expression": None,
                "parameters": {"MouthOpen": 0.0, "EyeOpenLeft": 0.7, "EyeOpenRight": 0.7},
                "duration": 1.0,
...
if __name__ == "__main__":
    ...
    # 4. 使用情绪便捷方法
    scheduler.add_emotion_action("开心", intensity=0.8)
